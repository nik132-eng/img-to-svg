...
export function ConversionSettings({ onSettingsChange, isOpen, onToggle }: ConversionSettingsProps) {
  ...
  if (!isOpen) {
    return (
      <button
        onClick={onToggle}
        className="fixed bottom-6 right-6 bg-gray-700 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50"
      >
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gray-700 text-white p-6">
          ...
          <p className="text-gray-200 mt-2">Customize your SVG conversion for optimal results</p>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="flex space-x-3 pt-6 border-t border-gray-200">
            ...
            <button
              onClick={onToggle}
              className="flex-1 bg-gray-700 text-white py-3 px-4 rounded-xl font-medium hover:bg-gray-800 transition-all transform hover:scale-105"
            >
              Apply Settings
            </button>
          </div>
